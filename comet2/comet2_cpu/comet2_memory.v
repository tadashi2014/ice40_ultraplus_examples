/*
 * 48K x 16-bit COMET II main memory.
 *
 * COMET word addresses:
 *   0x0000 - 0xBFFF : this RAM
 *
 * The implementation uses three iCE40 UltraPlus SPRAM blocks.  Each block is
 * used as 16K x 16-bit storage.
 */
