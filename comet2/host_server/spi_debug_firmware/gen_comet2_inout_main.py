...
emit(0x0040, op(0x10, 3, 0), "LD GR3,#F000")
emit(0x0041, 0xF000, "SPI status")
emit(0x0042, op(0x30, 3, 0), "AND GR3,ONE")
emit(0x0043, 0x00A1, "ONE")
emit(0x0044, op(0x63, 0, 0), "JZE SVC1_IN")
emit(0x0045, 0x0040, "SVC1_IN")
emit(0x0046, op(0x10, 3, 0), "LD GR3,#F001")
emit(0x0047, 0xF001, "SPI RX low")
...
emit(0x004E, op(0x10, 3, 0), "LD GR3,#F002")
emit(0x004F, 0xF002, "SPI RX high")
...
emit(0x005A, op(0x11, 4, 0), "ST GR4,#F003")
emit(0x005B, 0xF003, "SPI RX ack")
...
emit(0x0062, op(0x11, 4, 0), "ST GR4,#F003")
emit(0x0063, 0xF003, "SPI RX ack")
emit(0x0064, op(0x64, 0, 0), "JUMP SVC1_IN")
emit(0x0065, 0x0040, "SVC1_IN")

emit(0x0080, op(0x10, 3, 0), "LD GR3,#F000")
emit(0x0081, 0xF000, "SPI status")
...
emit(0x008E, op(0x11, 3, 0), "ST GR3,#F004")
emit(0x008F, 0xF004, "SPI TX low")
emit(0x0090, op(0x12, 4, 0), "LAD GR4,0")
emit(0x0091, 0x0000, "0")
emit(0x0092, op(0x11, 4, 0), "ST GR4,#F005")
emit(0x0093, 0xF005, "SPI TX commit")
